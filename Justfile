...
# trace-writer sibling static lib + ct-print (Layout-A trace decode) via the
# dev env and exports CODETRACER_NIM_LIB_DIR to later steps under GitHub
# Actions. Shebang recipe so shell state persists across lines.
